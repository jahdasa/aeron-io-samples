...
public class AeronPublisher {
    ...
    private static final IdleStrategy OFFER_IDLE_STRATEGY = Configuration.agentIdleStrategy("org.agrona.concurrent.BackoffIdleStrategy", null);

    public AeronPublisher(String contextDir){
        this.publications = new ObjectObjectHashMap<>();
